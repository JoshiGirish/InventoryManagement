...
from InvManage.serializers import PPEntrySerializer, InvoiceSerializer
...
def display_purchase_orders_view(request):
	if request.method == 'GET':
		...
		print(page_obj)
		for dict in dictionaries: # dictionary contains only vendor id and not vendor name. So add it.
